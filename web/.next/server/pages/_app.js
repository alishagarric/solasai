...
})(["&.", "{position:fixed;display:none;background:", ";color:", ";top:0;bottom:0;right:0;left:0;z-index:999;padding:", ";flex-direction:column;justify-content:space-between;.", "{position:absolute;height:80%;right:-20%;width:auto;top:50%;transform:translateY(-50%);z-index:0;}.", "__exit,.", "__links,.", "{position:relative;z-index:1;}.", "__exit{padding-bottom:calc(", " * 3);.", "{width:30px;height:auto;}}.", "__links{flex:1;&__list{&__item{a{font-size:10vw;text-transform:uppercase;font-weight:600;padding:2vw 0;display:block;}}}}&.__active{display:flex;~ main,~ footer{display:none;}}}"], NavigationOverlayClassName, Theme["a" /* Theme */].Color.Text, Theme["a" /* Theme */].Color.White, Root["a" /* Root */].Size, BlueBirdClassName, NavigationOverlayClassName, NavigationOverlayClassName, ContactInfoClassName, NavigationOverlayClassName, Root["a" /* Root */].Size, ExitClassName, NavigationOverlayClassName);
